...
namespace XamarinListViewCollectionView.Services
{
    using System;
    ...
    namespace SharpnadoExemplo.Services
    {
        public class NavigationService
        {
            ...
            public async Task PushAsync<TViewModel>(bool modal = false, params object[] args) where TViewModel : BaseViewModel
            {
                ...
                await (args.Length > 0 ? (page.BindingContext as BaseViewModel).LoadAsync(args) : (page.BindingContext as BaseViewModel).LoadAsync());
            }
